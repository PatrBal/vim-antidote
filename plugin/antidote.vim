...
function! s:AntidoteDict(word)
	call system("osascript -e \'tell application \"AgentAntidoteConnect\" to lance module dictionnaires ouvrage definitions mot \"" . a:word . "\"\' -e \'delay 1\' - e \'tell application \"System Events\" to tell application process \"Antidote 11\" to set frontmost to true\'")
	redraw!
endfunction
