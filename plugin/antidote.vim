...
function! s:AntidoteDict(word)
	call system("osascript -e \'tell application \"AgentAntidoteConnect\" to lance module dictionnaires ouvrage definitions mot \"" . a:word . "\"\' - e \'tell application \"Antidote\" to activate\'")
	redraw!
endfunction
